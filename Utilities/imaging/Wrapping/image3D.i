...
//%extend Image3D {};
%template(Image3Ddouble) Image3D<double>;
%template(Image3Dfloat)  Image3D<float>;
%template(Image3Dulong)  Image3D<unsigned long>;
%template(Image3Dlong)   Image3D<long>;
%template(Image3Duint)   Image3D<unsigned int>;
%template(Image3Dint)    Image3D<int>;
%template(Image3Dushort) Image3D<unsigned short>;
%template(Image3Dshort)  Image3D<short>;
%template(Image3Dubyte)  Image3D<unsigned char>;
%template(Image3Dbyte)   Image3D<char>;
