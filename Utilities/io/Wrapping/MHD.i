...
%apply (double* IN_ARRAY1, int DIM1) {(double* numpy_input_spacing, int field_size)};
%apply (float* IN_ARRAY1, int DIM1) {(float* numpy_input_spacing, int field_size)};
%apply (char* IN_ARRAY1, long DIM1) {(char* numpy_input_data, long field_size)}
%apply (unsigned char* IN_ARRAY1, long DIM1) {(unsigned char* numpy_input_data, long field_size)}
%apply (short* IN_ARRAY1, long DIM1) {(short* numpy_input_data, long field_size)}
%apply (unsigned short* IN_ARRAY1, long DIM1) {(unsigned short* numpy_input_data, long field_size)}
%apply (int* IN_ARRAY1, long DIM1) {(int* numpy_input_data, long field_size)}
%apply (unsigned int* IN_ARRAY1, long DIM1) {(unsigned int* numpy_input_data, long field_size)}
%apply (long* IN_ARRAY1, long DIM1) {(long* numpy_input_data, long field_size)}
%apply (unsigned long* IN_ARRAY1, long DIM1) {(unsigned long* numpy_input_data, long field_size)}
%apply (float* IN_ARRAY1, long DIM1) {(float* numpy_input_data, long field_size)}
%apply (double* IN_ARRAY1, long DIM1) {(double* numpy_input_data, long field_size)};

%apply (unsigned int* ARGOUT_ARRAY1, int DIM1) {(unsigned int* numpy_output_dimensions, int field_size)};
%apply (float* ARGOUT_ARRAY1, int DIM1) {(float* numpy_output_spacing, int field_size)};
%apply (char* ARGOUT_ARRAY1, long DIM1) {(char* numpy_output_data, long field_size)};
%apply (unsigned char* ARGOUT_ARRAY1, long DIM1) {(unsigned char* numpy_output_data, long field_size)};
%apply (short* ARGOUT_ARRAY1, long DIM1) {(short* numpy_output_data, long field_size)};
%apply (unsigned short* ARGOUT_ARRAY1, long DIM1) {(unsigned short* numpy_output_data, long field_size)};
%apply (int* ARGOUT_ARRAY1, long DIM1) {(int* numpy_output_data, long field_size)};
%apply (unsigned int* ARGOUT_ARRAY1, long DIM1) {(unsigned int* numpy_output_data, long field_size)};
%apply (long* ARGOUT_ARRAY1, long DIM1) {(long* numpy_output_data, long field_size)};
%apply (unsigned long* ARGOUT_ARRAY1, long DIM1) {(unsigned long* numpy_output_data, long field_size)};
%apply (float* ARGOUT_ARRAY1, long DIM1) {(float* numpy_output_data, long field_size)};
%apply (double* ARGOUT_ARRAY1, long DIM1) {(double* numpy_output_data, long field_size)};
...
%apply (double* IN_FARRAY1, int DIM1) {(double* numpy_input_spacing, int field_size)};
%apply (float* IN_FARRAY1, int DIM1) {(float* numpy_input_spacing, int field_size)};
%apply (char* IN_FARRAY1, long DIM1) {(char* numpy_input_data, long field_size)}
%apply (unsigned char* IN_FARRAY1, long DIM1) {(unsigned char* numpy_input_data, long field_size)}
%apply (short* IN_FARRAY1, long DIM1) {(short* numpy_input_data, long field_size)}
%apply (unsigned short* IN_FARRAY1, long DIM1) {(unsigned short* numpy_input_data, long field_size)}
%apply (int* IN_FARRAY1, long DIM1) {(int* numpy_input_data, long field_size)}
%apply (unsigned int* IN_FARRAY1, long DIM1) {(unsigned int* numpy_input_data, long field_size)}
%apply (long* IN_FARRAY1, long DIM1) {(long* numpy_input_data, long field_size)}
%apply (unsigned long* IN_FARRAY1, long DIM1) {(unsigned long* numpy_input_data, long field_size)}
%apply (float* IN_FARRAY1, long DIM1) {(float* numpy_input_data, long field_size)}
%apply (double* IN_FARRAY1, long DIM1) {(double* numpy_input_data, long field_size)};
