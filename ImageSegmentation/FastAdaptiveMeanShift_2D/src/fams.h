...
// --- timer functions - replaced by own clocking --- //
...
// --- sorting function --- //
// sort double vector - ascending order
void bgSort(double* ra, int nVec)
{
	// n = N = number of entities
	// l = half-way point (mid entity)
...
// @param ra:   value field (here, e.g., # of elements in a node)
// @param ira:  index field, dependent on @ra
// @param nVec: size of the vector field
